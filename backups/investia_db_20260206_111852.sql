...
\restrict V6EijikuO1YTRAEIhdzpVy85tz9GolUwTAsvp0NrEapGRBUxjNmtvexepOcOCPa
...
COPY public.users (id, email, name, created_at, updated_at, password, deleted_at) FROM stdin;
\.
...
\unrestrict V6EijikuO1YTRAEIhdzpVy85tz9GolUwTAsvp0NrEapGRBUxjNmtvexepOcOCPa
